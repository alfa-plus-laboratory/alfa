#!/usr/bin/env bun
/**
 * Direct tool harness — skips the LLM and runs a single tool on the arguments you feed it.
 *
 ...
 *
 * Permissions are always auto-allowed (--deny switches to always-deny, for exercising the
 * error paths).
 */
